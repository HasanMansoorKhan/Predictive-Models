...
The last predictive model uses the Classification and Regression Tree also known as CART which builds a binary tree-like structure. Each node represents a binary decision. One of the key benefits of CART is interpretability as seen in the visualization below. 
